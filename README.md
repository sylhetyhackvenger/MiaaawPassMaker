...
| Feature | Description |
|---------|-------------|
| 🔑 Secure Password Generation | Generates strong randomized passwords using uppercase, lowercase, numbers, and symbols |
| 🎯 Custom Secret Integration | Embed your own custom keyword or secret into generated passwords |
| 📁 Automatic Password Saving | Stores generated passwords inside `passave.txt` |
| 📜 Password History | Displays the latest generated passwords in a structured dashboard |
...
| 📂 History Loader | Loads previous password records automatically |
| 🎨 Professional CLI | Clean tables, banners, colors, and dashboard layout |
| ⚙️ Interactive Menu | Simple guided password creation process |
| 💾 Persistent Storage | Password history remains available after restart |
